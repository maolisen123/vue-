...
<div class="list_model" @click="phone()">
		<div class="list_title clearfix">
			<h3 class="fl" id="model01">手机/电脑</h3>
		...
		<div class="goods_con clearfix">
			<div class="goods_banner fl"><img src="../assets/phone2.jpg">
			<ul class="goods_list fl">
				<li>
					<h4><a href="#">iPhone12</a></h4>
					<a href="#"><img src="../assets/phone2.jpg"></a>
					<div class="prize">¥ 6666</div>
				</li>
				<li>
					<h4><a href="#">iPhone11</a></h4>
					<a href="#"><img src="../assets/phone2.jpg"></a>
					<div class="prize">¥ 5555</div>
				</li>
				<li>
					<h4><a href="#">vivo</a></h4>
					<a href="#"><img src="../assets/phone2.jpg"></a>
					<div class="prize">¥ 7777</div>
				</li>
				<li>
					<h4><a href="#">oppo</a></h4>
					<a href="#"><img src="../assets/phone2.jpg"></a>
					<div class="prize">¥ 8888</div>
				</li>
			</ul>
		</div>
	</div>
		...
		<div class="goods_con clearfix">
			...
			<ul class="goods_list fl">
				<li>
					<h4><a href="#">坚果r2</a></h4>
					<a href="#"><img src="../assets/phone2.jpg"></a>
					<div class="prize">¥ 12456</div>
				</li>
				<li>
					<h4><a href="#">iphonexmax</a></h4>
					<a href="#"><img src="../assets/phone2.jpg"></a>
					<div class="prize">¥ 123456</div>
				</li>
				<li>
					<h4><a href="#">oppo55</a></h4>
					<a href="#"><img src="../assets/phone2.jpg"></a>
					<div class="prize">¥38465</div>
				</li>
				<li>
					<h4><a href="#">vivox12</a></h4>
					<a href="#"><img src="../assets/phone2.jpg"></a>
					<div class="prize">¥ 66665</div>
				</li>
			</ul>
		</div>
	</div>
